...
type CurrentSessionDetails struct {
	...
	Ip_Details currentIpDetails `bson:"ip_details"`
...
//Languages []currentLanguages `json:"languages" bson:"languages"`
